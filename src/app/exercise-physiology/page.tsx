...
const profession = getProfession("exercise-physiology")!;

export const metadata: Metadata = {
  title: profession.metaTitle,
  description: profession.metaDescription,
  alternates: { canonical: "/exercise-physiology" },
};
...
export default function ExercisePhysiologyPage() {
  return (
    <>
      ...
      <section className="py-16 sm:py-24">
        <div className="container-narrow">
          ...
          <div className="mt-8 space-y-5 text-[var(--color-ink-light)] leading-relaxed">
            <p>
              Exercise physiology is the fastest-growing allied health profession
              in Australia, and more EPs are moving into private practice every
              year. But it comes with a set of complications that other
              professions don&apos;t face. You&apos;re not AHPRA-regulated (you&apos;re
              accredited through ESSA instead), which changes how some Medicare
              and business rules apply to you. And there&apos;s a GST question that
              trips up a lot of EPs.
            </p>
            <p>
              The business guidance landscape for exercise physiologists is
              essentially empty. ESSA provides accreditation support and some
              professional resources, but when it comes to the practical
              mechanics of setting up a practice, getting a provider number,
              understanding CDM billing, and building a referral network?
              There&apos;s almost nothing.
            </p>
            <p>
              You also face a positioning challenge. Personal trainers, strength
              coaches, and physiotherapists all overlap with parts of your scope.
              GPs are still learning what an accredited exercise physiologist
              does. Building referral relationships takes more active education
              than it does for a physio or podiatrist.
            </p>
          </div>
        </div>
      </section>

      {/* EP-specific GST callout */}
      <section className="py-8">
        <div className="container-narrow">
          <div className="p-6 bg-[var(--color-accent-bg)] border border-[var(--color-accent)]/20 rounded-xl">
            ...
            <p className="text-sm text-[var(--color-ink-light)] leading-relaxed">
              Most allied health services are GST-free under the medical
              exemption. But for EPs, the exemption only applies when the
              service is &ldquo;treatment&rdquo; of a diagnosed condition. General fitness,
              wellness, or performance services may attract GST. If your annual
              revenue exceeds $75K, you need to register for GST and understand
              which of your services are exempt. Get accounting advice on this
              early.{" "}
              <Link
                href="/guides/business-structure"
                className="font-medium text-[var(--color-primary)] hover:underline"
              >
                Read more in the business structure guide
              </Link>
              .
            </p>
          </div>
            ...
            <div className="p-6 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <dd className="font-medium text-[var(--color-ink)]">No (self-regulated via ESSA)</dd>
                </div>
              </dl>
            </div>
      ...
      <CTABanner source="exercise-physiology-page" />
    </>
  );
}
